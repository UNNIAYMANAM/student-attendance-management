...
<div id="bodySection">
    <div class="container">
        <div class="row pt-4 pb-2 align-items-center">
            <div class="col-md-12">
                <img src="uploads/CMS-logo.png" class="img-fluid">
            </div>
        </div>
        <div class="row py-1">
            <div class="col-md-7 text-center">
                <img src="uploads/name.jpg" class="img-fluid" width="100%">
            </div>
            <div class="col-md-5 text-center">
                <div id="loginSection" class="text-center">
                <br>
                    <h4>Faculty Login</h4>
                    <h4><i class="fa fa-user-circle fa-3x py-2" style="color:#c0392b"></i></h4>
                    <form>
                        ...
                        <div class="form-row py-1 px-5">
                            <div class="form-group col-md-12">
                            <input type="button" style="background-color:#c0392b" onclick="loginFun()" class="form-control btn btn-success" value="Login">
