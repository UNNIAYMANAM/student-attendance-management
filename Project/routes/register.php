                ...
                <div id="regSection" class="text-center">
                    <form id="regForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row py-1">
                            ...
                            <input onclick="regFun()" type="button" style="background-color:#c0392b; color:white" class="form-control btn btn-success" id="register" value="Register">
                            </div>
                            <div class="form-group col-md-3"></div>
                        </div>
                    </form>
                    <a href="../"><button type="button" class="btn" style="background-color:#c0392b; color:white">Back</button></a>
