                ...
                <div id="loginSection" class="text-center p-5">
                    <form>
                        ...
                        <div class="form-row py-1">
                            ...
                            <input type="button" id="changePass" style="background-color:#c0392b; color:white"  class="form-control btn btn-success" value="Change">
                            </div>
                        </div>
                        <div class="form-row py-1">
                            <div class="form-group col-md-12 px-5">
                            <a href="../" class="form-control btn" style="background-color:#c0392b; color:white">Back</a>   
                            </div>
                        </div>
                    </form>
                </div>
